...
#import "GetTemplateViewController.h"
#import "Template.h"
#import "GetTemplateCell.h"

@interface GetTemplateViewController ()<NSFetchedResultsControllerDelegate,UITableViewDataSource,UITableViewDelegate>
...
@implementation GetTemplateViewController
...
{
    GetTemplateCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cellMyTemplate"];
    cell.autoresizesSubviews = NO;
    [self configureCell:cell AtIndexPath:indexPath];
    
    return cell;
}
-(void)configureCell:(GetTemplateCell*)cell AtIndexPath:(NSIndexPath*)indexPath
{
