...
@interface WriteCaseEditViewController ()<UITableViewDataSource,UITableViewDelegate, /*HUDSubViewControllerDelegate*/ConditionTemplateViewControllerDelegate>
...
- (IBAction)lefTopButton:(UIButton *)sender
{
